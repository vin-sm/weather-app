...
function NoLocationView() {
  ...
  const fetchData = fetchWeatherInfo(weatherInfos, setWeatherData, setTags, tags);
...
function fetchWeatherInfo(weatherInfos: WeatherData[], setWeatherData: React.Dispatch<React.SetStateAction<WeatherData | null>>, setTags: React.Dispatch<React.SetStateAction<string[]>>, tags: string[]) {
    ...
    const fetchData = async (city: string) => {
        try {
            ...
            if (newData != null && newData != undefined) {
                ...
                const minutes = Math.floor((dayLength % (60 * 60 * 1000)) / (60 * 1000));
                console.log(hours);
